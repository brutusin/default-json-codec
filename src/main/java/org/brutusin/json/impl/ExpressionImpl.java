...
public class ExpressionImpl implements Expression {
    ...
    private ExpressionImpl(Queue<String> elements, String expression) {
        if (elements == null) {
     ...
     * @return
     */
    public static ExpressionImpl compile(String exp) {
        ...
        return new ExpressionImpl(queue, exp);
    }
    ...
    public static void main(String[] args) {
        ExpressionImpl exp = ExpressionImpl.compile("$.map[\"akey\"].array[*]");
        System.out.println(exp.getTokens());
    }
}
